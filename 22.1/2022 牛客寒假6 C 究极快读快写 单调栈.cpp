...
namespace fastio{
int gc(){
const int Q=(1<<21)+1;static char in[Q],*is=in,*it=in;return is==it?it=(is=in)+fread(in,1,Q,stdin),(is==it?EOF:*is++):*is++;}
...
template<class A,class ...B>inline void print(A a,char c,B...b){print(a,c);print(b...);}
